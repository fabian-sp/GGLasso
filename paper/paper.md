...
![Runtime comparison for SGL problems of varying dimension and sample size at three different $\lambda_1$ values. The left colmun shows the runtime at low accuracy, the right column at high accuracy.](../docs/source/pictures/runtime_merged.png){width=50%}
